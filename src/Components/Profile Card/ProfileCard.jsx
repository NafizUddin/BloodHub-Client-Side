      ...
      <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-20 lg:my-0">
        ...
        >
          <div className="p-4 md:p-12 text-center lg:text-left">
            ...
            <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start uppercase">
              <svg
                className="h-4 fill-current text-[#D60C0C] pr-4"
            ...
            <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
              <MdEmail className="text-[#D60C0C] mr-4 text-lg" />
              Email: {loadedUser?.email}
            </p>
            <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
              <MdOutlineLocationOn className="text-[#D60C0C] mr-4 text-lg" />
              Address: {loadedUser?.upazilla}, {loadedUser?.district}
            </p>
            <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
              <MdBloodtype className="text-[#D60C0C] mr-4 text-lg" />
              Blood Group: {loadedUser?.bloodGroup}
            </p>
