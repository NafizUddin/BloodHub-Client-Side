const DashBoard = () => {
  return (
    <div className="bg-gray-100 dark:bg-gray-900">
      <aside className="fixed top-0 z-50 ml-[-100%] flex w-full flex-col justify-between border-r bg-white px-6 pb-3 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%] dark:bg-gray-800 dark:border-gray-700">
        <div>
